...
def test_get_prices_falls_back_to_healthy_provider_and_caches_serialized_rows():
    ...
    assert router.cache.saved_prices == [("router_price_AAPL_end=2024-01-02_start=2024-01-01", [{"close": 10}])]
...
def test_get_financial_metrics_applies_limit_and_caches_trimmed_rows():
    ...
    assert router.cache.saved_metrics == [("router_fundamental_AAPL_end=2024-01-02_limit=1", [{"ticker": "AAPL"}])]
