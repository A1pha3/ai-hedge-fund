"""ATR 计算工具测试 — 验证 Wilder True Range + SMA + 止损价计算."""
...
def _prices(closes: list[float], highs: list[float] | None = None, lows: list[float] | None = None):
    n = len(closes)
