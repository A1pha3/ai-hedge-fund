...
class _AlwaysHitSetup(Setup):
    ...
    def detect(self, ticker, trade_date, context):
        return DetectionResult(hit=True, ticker=ticker, trade_date=trade_date, trigger_strength=1.0, invalidation_condition="n/a")
...
def test_build_distribution_skips_non_hits():
    ...
    class _SometimesHit(Setup):
        ...
        def detect(self, ticker, trade_date, context):
            ...
            return DetectionResult(hit=hit, ticker=ticker, trade_date=trade_date, trigger_strength=1.0 if hit else 0.0, invalidation_condition="n/a")
