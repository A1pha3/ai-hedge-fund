...
def test_build_rule_variants_supports_expected_names():
    variants = build_rule_variants(["baseline", "profitability_inactive", "neutral_mean_reversion_guarded_033_no_hard_cliff"])
    ...
    assert variants[2].env["LAYER_B_ANALYSIS_NEUTRAL_MEAN_REVERSION_MODE"] == "guarded_dual_leg_033_no_hard_cliff"
