...
# ---------------------------------------------------------------------------
# _has_bearish_fundamental_consensus / _has_conflicting_trend_and_reversion / _extract_hurst_exponent
# ---------------------------------------------------------------------------
...
class TestHasBearishFundamentalConsensus:
    def test_consensus_when_fundamental_and_other_bearish(self):
        ...
        signals = {
            "trend": StrategySignal(direction=-1, confidence=78.0, completeness=1.0, sub_factors={}),
        }
    ...
    def test_no_consensus_when_other_bearish_below_threshold(self):
        ...
        fundamental = StrategySignal(direction=-1, confidence=80.0, completeness=1.0, sub_factors={})
        signals = {
            "trend": StrategySignal(direction=-1, confidence=74.0, completeness=1.0, sub_factors={}),
        }
        assert _has_bearish_fundamental_consensus(signals, fundamental) is False
    ...
    def test_no_consensus_when_no_other_bearish(self):
        ...
        fundamental = StrategySignal(direction=-1, confidence=80.0, completeness=1.0, sub_factors={})
        signals = {
            "trend": StrategySignal(direction=1, confidence=90.0, completeness=1.0, sub_factors={}),
        }
        assert _has_bearish_fundamental_consensus(signals, fundamental) is False
...
class TestExtractHurstExponent:
    def test_extracts_value(self):
        ...
        mr = StrategySignal(
            ...
            confidence=60.0,
            completeness=1.0,
            sub_factors={"hurst_regime": {"metrics": {"hurst_exponent": 0.42}}},
        )
