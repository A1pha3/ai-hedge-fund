...
import scripts.analyze_btst_5d_15pct_objective_monitor as objective_monitor
...
def test_analyze_btst_5d_15pct_objective_monitor_ranks_tradeable_and_false_negative_cases(tmp_path: Path, monkeypatch) -> None:
    ...
    outcomes = {
        ...
        ("001309", "2026-03-27"): {"data_status": "ok", "cycle_status": "closed_cycle", "max_future_high_return_2_5d": 0.16, "future_high_hit_15pct_2_5d": True, "time_to_hit_15pct": 2},
        ("600821", "2026-03-27"): {"data_status": "ok", "cycle_status": "closed_cycle", "max_future_high_return_2_5d": 0.08, "future_high_hit_15pct_2_5d": False, "time_to_hit_15pct": None},
    }
    ...
    analysis = objective_monitor.analyze_btst_5d_15pct_objective_monitor(reports_root, leaderboard_min_closed_cycle_count=1)
    ...
    markdown = objective_monitor.render_btst_5d_15pct_objective_monitor_markdown(analysis)
    assert "# BTST 5D / +15% Objective Monitor" in markdown
