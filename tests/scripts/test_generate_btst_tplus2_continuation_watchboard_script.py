        ...
        json.dumps(
            {
                ...
                "queue_rows": [{"ticker": "300505", "priority_rank": 2, "candidate_tier_focus": "observation_candidate", "recent_tier_verdict": "recent_tier_confirmed", "promotion_readiness_verdict": "validation_queue_ready"}],
            }
        ),
        encoding="utf-8",
    )
