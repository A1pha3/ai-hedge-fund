...
def build_strict_btst_objective_gate(objective_monitor: dict[str, Any]) -> dict[str, Any]:
    blockers: list[str] = []
...
def load_strict_btst_objective_gate_from_markdown(path: str | Path) -> dict[str, Any]:
    return build_strict_btst_objective_gate(parse_objective_monitor_markdown(path))
...
def main(argv: list[str] | None = None) -> int:
    ...
    payload = load_strict_btst_objective_gate_from_markdown(args.input_md)
