...
def compare_profiles():
    ...
    scenarios = {
        "Strong momentum+reversal (classic v2 win)": {
            ...
            "catalyst_freshness": 0.3,
            "layer_c_alignment": 0.3,
            "momentum_strength": 0.8,
            "short_term_reversal": 0.9,
            "intraday_strength": 0.7,
            "reversal_2d": 0.8,
        },
        "Weak reversal, strong trend": {
            "breakout_freshness": 0.3,
            "trend_acceleration": 0.9,
            "volume_expansion_quality": 0.5,
            "close_strength": 0.6,
            "sector_resonance": 0.5,
            "catalyst_freshness": 0.4,
            "layer_c_alignment": 0.4,
        ...
        "Pure reversal play": {
            ...
            "volume_expansion_quality": 0.2,
            "close_strength": 0.3,
            "sector_resonance": 0.2,
            "catalyst_freshness": 0.1,
            "layer_c_alignment": 0.2,
            "momentum_strength": 0.1,
            "short_term_reversal": 0.95,
            "intraday_strength": 0.2,
            "reversal_2d": 0.9,
        },
