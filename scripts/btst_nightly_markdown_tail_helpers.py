...
def append_nightly_overview_candidate_pool_followup_tail_markdown(
    ...
    if early_runner_summary:
        ...
        lines.append(
            f"- early_runner_summary: deployment_mode={early_runner_summary.get('deployment_mode')} ready_for_shadow_rollout={early_runner_summary.get('ready_for_shadow_rollout')} failed_items={early_runner_summary.get('failed_items')} promotion_blockers={early_runner_summary.get('promotion_blockers')} latest_trade_date={latest_daily_board.get('trade_date')} latest_gate={latest_daily_board.get('btst_regime_gate')} latest_action={latest_daily_board.get('gate_action')} latest_watchlist={latest_daily_board.get('watchlist_tickers')} latest_priority={latest_daily_board.get('priority_tickers')} latest_second_entry={latest_daily_board.get('second_entry_tickers')} latest_theme_radar_top={latest_daily_board.get('theme_radar_top')} latest_industry_radar_top={latest_daily_board.get('industry_radar_top')} runtime_candidate_count={early_runner_summary.get('runtime_candidate_count')} daily_table_paths={latest_daily_board.get('daily_table_paths')}"
        )
