...
def queue_pending_buy(ticker: str, original_score: float, queue_date: str, reason: str = "limit_up_block") -> PendingOrder:
    return PendingOrder(ticker=ticker, order_type="buy", original_score=original_score, queue_date=queue_date, queue_days=1, reason=reason)


def queue_pending_sell(ticker: str, original_score: float, queue_date: str, reason: str = "limit_down_block") -> PendingOrder:
    return PendingOrder(ticker=ticker, order_type="sell", original_score=original_score, queue_date=queue_date, queue_days=1, reason=reason)
