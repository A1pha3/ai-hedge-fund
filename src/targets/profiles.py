...
SHORT_TRADE_TARGET_PROFILES: dict[str, ShortTradeTargetProfile] = {
    "default": ShortTradeTargetProfile(
        ...
        visibility_gap_continuation_breakout_freshness_min=0.32,
        visibility_gap_continuation_trend_acceleration_min=0.78,
        visibility_gap_continuation_close_strength_min=0.88,
        visibility_gap_continuation_catalyst_freshness_floor=0.35,
        visibility_gap_continuation_near_miss_threshold=0.44,
        ...
        merge_approved_continuation_near_miss_threshold=0.42,
