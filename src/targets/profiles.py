...
SHORT_TRADE_TARGET_PROFILES: dict[str, ShortTradeTargetProfile] = {
    "default": ShortTradeTargetProfile(
        ...
        profitability_hard_cliff_boundary_relief_trend_acceleration_min=0.50,
        profitability_hard_cliff_boundary_relief_catalyst_freshness_min=0.10,
        profitability_hard_cliff_boundary_relief_sector_resonance_min=0.10,
        profitability_hard_cliff_boundary_relief_close_strength_min=0.60,
        profitability_hard_cliff_boundary_relief_stale_penalty_max=0.55,
        profitability_hard_cliff_boundary_relief_extension_penalty_max=0.55,
        profitability_hard_cliff_boundary_relief_near_miss_threshold=0.32,
