...
def _resolve_catalyst_theme_penalty(
    *,
    input_data: TargetEvaluationInput,
    profile: Any,
) -> dict[str, Any]:
    return resolve_catalyst_theme_penalty_impl(
        input_data=input_data,
        profile=profile,
        normalized_reason_codes=_normalized_reason_codes,
        exempt_carryover_candidate_fn=_is_catalyst_theme_carryover_candidate,
        clamp_unit_interval_fn=clamp_unit_interval,
    )
...
def _resolve_short_trade_snapshot_reliefs(
    ...
    *,
    ...
    return resolve_short_trade_snapshot_reliefs_impl(
        ...
        resolve_catalyst_theme_penalty=_resolve_catalyst_theme_penalty,
...
def _build_short_trade_top_reasons(
    *,
    ...
    raw_catalyst_freshness: float = 0.0,
    upstream_shadow_catalyst_relief_applied: bool = False,
    upstream_shadow_catalyst_relief_reason: str = "",
    visibility_gap_continuation_relief: dict[str, Any] | None = None,
    merge_approved_continuation_relief: dict[str, Any] | None = None,
    prepared_breakout_penalty_relief: dict[str, Any] | None = None,
    prepared_breakout_catalyst_relief: dict[str, Any] | None = None,
    prepared_breakout_volume_relief: dict[str, Any] | None = None,
    prepared_breakout_continuation_relief: dict[str, Any] | None = None,
    prepared_breakout_selected_catalyst_relief: dict[str, Any] | None = None,
    profitability_relief_applied: bool = False,
    profitability_hard_cliff_boundary_relief: dict[str, Any] | None = None,
    historical_execution_relief: dict[str, Any] | None = None,
    event_catalyst_assessment: dict[str, Any] | None = None,
    profitability_hard_cliff: bool = False,
    breakout_stage: str = "",
    layer_c_avoid_penalty: float = 0.0,
    stale_trend_repair_penalty: float = 0.0,
    overhead_supply_penalty: float = 0.0,
    extension_without_room_penalty: float = 0.0,
    breakout_trap_guard: dict[str, Any] | None = None,
    market_state_threshold_adjustment: dict[str, Any] | None = None,
    catalyst_theme_guard: dict[str, Any] | None = None,
    ...
    return _helper(
        state=ShortTradeTopReasonsState(
            ...
            trend_acceleration=trend_acceleration,
            raw_catalyst_freshness=raw_catalyst_freshness,
            upstream_shadow_catalyst_relief_applied=bool(upstream_shadow_catalyst_relief_applied),
            upstream_shadow_catalyst_relief_reason=upstream_shadow_catalyst_relief_reason,
            visibility_gap_continuation_relief=dict(visibility_gap_continuation_relief or {}),
            merge_approved_continuation_relief=dict(merge_approved_continuation_relief or {}),
            prepared_breakout_penalty_relief=dict(prepared_breakout_penalty_relief or {}),
            prepared_breakout_catalyst_relief=dict(prepared_breakout_catalyst_relief or {}),
            prepared_breakout_volume_relief=dict(prepared_breakout_volume_relief or {}),
            prepared_breakout_continuation_relief=dict(prepared_breakout_continuation_relief or {}),
            prepared_breakout_selected_catalyst_relief=dict(prepared_breakout_selected_catalyst_relief or {}),
            profitability_relief_applied=bool(profitability_relief_applied),
            profitability_hard_cliff_boundary_relief=dict(profitability_hard_cliff_boundary_relief or {}),
            historical_execution_relief=dict(historical_execution_relief or {}),
            event_catalyst_assessment=dict(event_catalyst_assessment or {}),
            profitability_hard_cliff=bool(profitability_hard_cliff),
            breakout_stage=breakout_stage,
            ...
            catalyst_theme_guard=dict(catalyst_theme_guard or {}),
