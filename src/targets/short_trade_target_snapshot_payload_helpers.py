...
def build_short_trade_target_snapshot_payload(
    *,
    ...
    payload = {
        ...
        "selected_close_retention_adjustment": relief_snapshot["selected_close_retention_adjustment"],
        "selected_close_retention_penalty": relief_snapshot["selected_close_retention_penalty"],
        "close_retention_score": relief_snapshot["close_retention_score"],
        "breakout_close_gap": relief_snapshot["breakout_close_gap"],
        "breakout_trap_guard": relief_snapshot["breakout_trap_guard"],
