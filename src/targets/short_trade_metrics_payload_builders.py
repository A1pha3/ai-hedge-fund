...
def _build_short_trade_threshold_core_metrics_payload(*, profile: Any, snapshot: dict[str, Any], positive_score_weights: dict[str, float]) -> dict[str, Any]:
    return {
        ...
        "selected_rank_cap_relief_catalyst_theme_research_close_strength_max": round(float(getattr(profile, "selected_rank_cap_relief_catalyst_theme_research_close_strength_max", 1.0) if getattr(profile, "selected_rank_cap_relief_catalyst_theme_research_close_strength_max", 1.0) is not None else 1.0), 4),
        ...
        "selected_breakout_close_gap_max": round(float(getattr(profile, "selected_breakout_close_gap_max", 1.0) if getattr(profile, "selected_breakout_close_gap_max", 1.0) is not None else 1.0), 4),
