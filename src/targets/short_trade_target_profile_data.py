...
SHORT_TRADE_TARGET_PROFILES["ignition_breakout"] = replace(
    ...
    committee_alpha_min_aggressive_trade=48.0,
    committee_beta_min_aggressive_trade=32.0,
    committee_gamma_min_aggressive_trade=46.0,
    committee_score_min_aggressive_trade=46.0,
    committee_alpha_min_normal_trade=50.0,
    committee_beta_min_normal_trade=36.0,
    committee_gamma_min_normal_trade=48.0,
    committee_score_min_normal_trade=48.0,
    select_threshold=0.35,
    near_miss_threshold=0.24,
)
...
SHORT_TRADE_TARGET_PROFILES["retention_follow"] = replace(
    ...
    committee_enabled=True,
    committee_alpha_weight=0.45,
    committee_beta_weight=0.30,
    committee_gamma_weight=0.25,
    committee_alpha_min_aggressive_trade=48.0,
    committee_beta_min_aggressive_trade=36.0,
    committee_gamma_min_aggressive_trade=46.0,
    committee_score_min_aggressive_trade=48.0,
    committee_alpha_min_normal_trade=50.0,
    committee_beta_min_normal_trade=38.0,
    committee_gamma_min_normal_trade=48.0,
    committee_score_min_normal_trade=50.0,
    select_threshold=0.40,
    near_miss_threshold=0.32,
    selected_close_retention_threshold_lift=0.03,
