...
MERGE_APPROVED_BREAKOUT_UPLIFT_EVENT_CONFIDENCE_MIN = get_env_float("DAILY_PIPELINE_MERGE_APPROVED_BREAKOUT_UPLIFT_EVENT_CONFIDENCE_MIN", 50.0)
MERGE_APPROVED_BREAKOUT_UPLIFT_MOMENTUM_CONFIDENCE_MIN = get_env_float("DAILY_PIPELINE_MERGE_APPROVED_BREAKOUT_UPLIFT_MOMENTUM_CONFIDENCE_MIN", 55.0)
MERGE_APPROVED_BREAKOUT_UPLIFT_EVENT_FRESHNESS_CONFIDENCE_MIN = get_env_float("DAILY_PIPELINE_MERGE_APPROVED_BREAKOUT_UPLIFT_EVENT_FRESHNESS_CONFIDENCE_MIN", 55.0)
MERGE_APPROVED_BREAKOUT_UPLIFT_TREND_CONFIDENCE_FLOOR = get_env_float("DAILY_PIPELINE_MERGE_APPROVED_BREAKOUT_UPLIFT_TREND_CONFIDENCE_FLOOR", 72.0)
MERGE_APPROVED_BREAKOUT_UPLIFT_EVENT_CONFIDENCE_FLOOR = get_env_float("DAILY_PIPELINE_MERGE_APPROVED_BREAKOUT_UPLIFT_EVENT_CONFIDENCE_FLOOR", 68.0)
MERGE_APPROVED_BREAKOUT_UPLIFT_MOMENTUM_CONFIDENCE_FLOOR = get_env_float("DAILY_PIPELINE_MERGE_APPROVED_BREAKOUT_UPLIFT_MOMENTUM_CONFIDENCE_FLOOR", 78.0)
MERGE_APPROVED_BREAKOUT_UPLIFT_EVENT_FRESHNESS_CONFIDENCE_FLOOR = get_env_float("DAILY_PIPELINE_MERGE_APPROVED_BREAKOUT_UPLIFT_EVENT_FRESHNESS_CONFIDENCE_FLOOR", 82.0)
MERGE_APPROVED_VOLUME_UPLIFT_VOLATILITY_CONFIDENCE_MIN = get_env_float("DAILY_PIPELINE_MERGE_APPROVED_VOLUME_UPLIFT_VOLATILITY_CONFIDENCE_MIN", 50.0)
MERGE_APPROVED_VOLUME_UPLIFT_VOLATILITY_CONFIDENCE_FLOOR = get_env_float("DAILY_PIPELINE_MERGE_APPROVED_VOLUME_UPLIFT_VOLATILITY_CONFIDENCE_FLOOR", 74.0)
MERGE_APPROVED_VOLUME_UPLIFT_VOLATILITY_REGIME_MIN = get_env_float("DAILY_PIPELINE_MERGE_APPROVED_VOLUME_UPLIFT_VOLATILITY_REGIME_MIN", 1.0)
MERGE_APPROVED_VOLUME_UPLIFT_ATR_RATIO_MIN = get_env_float("DAILY_PIPELINE_MERGE_APPROVED_VOLUME_UPLIFT_ATR_RATIO_MIN", 0.06)
MERGE_APPROVED_ALIGNMENT_UPLIFT_SCORE_C_MIN = get_env_float("DAILY_PIPELINE_MERGE_APPROVED_ALIGNMENT_UPLIFT_SCORE_C_MIN", -0.02)
MERGE_APPROVED_ALIGNMENT_UPLIFT_SCORE_C_MAX = get_env_float("DAILY_PIPELINE_MERGE_APPROVED_ALIGNMENT_UPLIFT_SCORE_C_MAX", 0.12)
MERGE_APPROVED_ALIGNMENT_UPLIFT_SCORE_C_FLOOR = get_env_float("DAILY_PIPELINE_MERGE_APPROVED_ALIGNMENT_UPLIFT_SCORE_C_FLOOR", 0.12)
MERGE_APPROVED_ALIGNMENT_UPLIFT_ANALYST_CONTRIBUTION_MAX = get_env_float("DAILY_PIPELINE_MERGE_APPROVED_ALIGNMENT_UPLIFT_ANALYST_CONTRIBUTION_MAX", 0.02)
MERGE_APPROVED_ALIGNMENT_UPLIFT_ANALYST_CONTRIBUTION_FLOOR = get_env_float("DAILY_PIPELINE_MERGE_APPROVED_ALIGNMENT_UPLIFT_ANALYST_CONTRIBUTION_FLOOR", 0.10)
MERGE_APPROVED_ALIGNMENT_UPLIFT_BLEND_B_WEIGHT = get_env_float("DAILY_PIPELINE_LAYER_C_BLEND_B_WEIGHT", 0.55)
MERGE_APPROVED_ALIGNMENT_UPLIFT_BLEND_C_WEIGHT = get_env_float("DAILY_PIPELINE_LAYER_C_BLEND_C_WEIGHT", 0.45)
MERGE_APPROVED_SECTOR_UPLIFT_INVESTOR_CONTRIBUTION_MAX = get_env_float("DAILY_PIPELINE_MERGE_APPROVED_SECTOR_UPLIFT_INVESTOR_CONTRIBUTION_MAX", 0.02)
MERGE_APPROVED_SECTOR_UPLIFT_INVESTOR_CONTRIBUTION_FLOOR = get_env_float("DAILY_PIPELINE_MERGE_APPROVED_SECTOR_UPLIFT_INVESTOR_CONTRIBUTION_FLOOR", 0.14)
