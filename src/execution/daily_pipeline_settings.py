...
SHORT_TRADE_BOUNDARY_CANDIDATE_SCORE_MIN = _get_env_float("DAILY_PIPELINE_SHORT_TRADE_BOUNDARY_CANDIDATE_SCORE_MIN", 0.20)
SHORT_TRADE_BOUNDARY_BREAKOUT_MIN = _get_env_float("DAILY_PIPELINE_SHORT_TRADE_BOUNDARY_BREAKOUT_MIN", 0.08)
SHORT_TRADE_BOUNDARY_TREND_MIN = _get_env_float("DAILY_PIPELINE_SHORT_TRADE_BOUNDARY_TREND_MIN", 0.18)
SHORT_TRADE_BOUNDARY_VOLUME_MIN = _get_env_float("DAILY_PIPELINE_SHORT_TRADE_BOUNDARY_VOLUME_MIN", 0.10)
SHORT_TRADE_BOUNDARY_CATALYST_MIN = _get_env_float("DAILY_PIPELINE_SHORT_TRADE_BOUNDARY_CATALYST_MIN", 0.08)
...
UPSTREAM_SHADOW_WATCHLIST_PROMOTION_LANES = _get_env_csv_set(
    "DAILY_PIPELINE_UPSTREAM_SHADOW_WATCHLIST_PROMOTION_LANES",
    "post_gate_liquidity_competition",
)
UPSTREAM_SHADOW_WATCHLIST_PROMOTION_MAX_TICKERS = _get_env_int(
