...
def get_currency_context(ticker: str) -> str:
    ...
    if is_ashare(ticker):
        return f"IMPORTANT: This is a Chinese A-share stock (ticker: {ticker}). All monetary values in the data are in CNY (Chinese Yuan, ¥). Use ¥ symbol when referencing monetary amounts, NOT $. For example: ¥100M, ¥3.7B, ¥11.75/share."
