...
def append_opening_watch_overview_markdown(lines: list[str], card: dict[str, Any]) -> None:
...
def append_opening_frontier_entries(lines: list[str], items: list[dict[str, Any]]) -> None:
