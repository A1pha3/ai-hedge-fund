...
def _analyze_lynch_debt_profile(financial_line_items: list) -> tuple[int, str]:
    de_ratio = None
...
def _analyze_lynch_operating_margin(financial_line_items: list) -> tuple[int, str]:
...
def _analyze_lynch_free_cash_flow(financial_line_items: list) -> tuple[int, str]:
...
def _describe_lynch_pe_and_growth(financial_line_items: list, market_cap: float) -> tuple[float | None, float | None, list[str]]:
    details: list[str] = []
...
def analyze_lynch_fundamentals(financial_line_items: list) -> dict:
    ...
    debt_score, debt_detail = _analyze_lynch_debt_profile(financial_line_items)
    raw_score += debt_score
    details.append(debt_detail)

    margin_score, margin_detail = _analyze_lynch_operating_margin(financial_line_items)
    raw_score += margin_score
    details.append(margin_detail)

    fcf_score, fcf_detail = _analyze_lynch_free_cash_flow(financial_line_items)
    raw_score += fcf_score
...
def analyze_lynch_valuation(financial_line_items: list, market_cap: float | None) -> dict:
    ...
    pe_ratio, eps_growth_rate, details = _describe_lynch_pe_and_growth(financial_line_items, market_cap)
