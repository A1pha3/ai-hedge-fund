...
def analyze_financial_strength(financial_line_items: list) -> dict:
    ...
    current_ratio_score, current_ratio_detail = _score_graham_current_ratio(current_assets, current_liabilities)
    score += current_ratio_score
    details.append(current_ratio_detail)

    debt_ratio_score, debt_ratio_detail = _score_graham_debt_ratio(total_assets, total_liabilities)
    score += debt_ratio_score
    details.append(debt_ratio_detail)

    dividend_score, dividend_detail = _score_graham_dividend_record(financial_line_items)
