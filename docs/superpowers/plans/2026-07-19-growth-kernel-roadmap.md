...
- [x] Plan 01 Revision 2 schema/ports implementation 与 completion gate 已验收（2026-08-04 独立审阅 MERGE-WITH-FOLLOWUPS 并合并入 main，含 full checked-in snapshot matrix），仓库内不再有下游代码依赖旧 `CapitalAuthorization`/`DecisionSeal` 作为最终接口。
