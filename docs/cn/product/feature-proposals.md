...
> **最后更新**：2026-06-17（Campaign 20：R42 survivorship-bias 审计原语 `filter_stock_basic_as_of` 交付（接线 deferred）；修复 BH-013 risk_off HOLD 被 mature_count=0 误判为 AVOID）
