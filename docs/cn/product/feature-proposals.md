...
> **最后更新**：2026-06-17（Campaign 45：完成 R63 回测基准收益率 + 成交额降级可观测性 BH-029 / BH-017 family backtesting 路径 silent-except 残留收口 — R60 "全量收口"声称修正，BH-017 家族在回测数据路径 mark-to-market R50 + benchmark/turnover R63 全量收口）
