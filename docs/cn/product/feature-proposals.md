...
| # | 功能 | 现状 | 改进方案 |
|---|------|------|----------|
| P1-6 | **组合风险预警仪表盘 (前端集成)** | 后端 `GET/POST /api/portfolio/risk-snapshot` 已就绪 | 前端完成实时 VaR / CVaR 卡片 + 行业集中度可视化 + 回撤预警线 |
...
剩余均为前端工作 (P1-6, P2-2/5/6/7/9), 后端 API 全部就绪。受限于无 CI/CD 和手动验证环境, 前端进度按需推进。
...
| Phase 4 (前端集成) | 2/7 (P2-1 ✅, P2-10 ✅) | P1-6, P2-2/5/6/7/9 |
| **后端** | **100%** 🎉 | — |
| **CLI** | **100%** 🎉 | — |
