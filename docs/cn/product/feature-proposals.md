...
> **最后更新**：2026-06-17（Campaign 49：BH-032 `--performance-report` 周期窗口 data-anchored 修复 — R36/R54/R61/R62 wall-clock-anchored lookback 家族在组合绩效报告路径的残留；新增 R66 已交付。R42 survivorship 接线仍 deferred 待独立授权 + live API 验证）
