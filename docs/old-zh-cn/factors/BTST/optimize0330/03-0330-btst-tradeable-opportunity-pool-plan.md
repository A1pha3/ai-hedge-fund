...
2. 基础数据归一化、分析、profile replay、report/control-tower、candidate-entry/frontier/release、runbook 编排等公共逻辑，应分别优先复用 [scripts/btst_data_utils.py](../../../../../scripts/btst_data_utils.py)、[scripts/btst_analysis_utils.py](../../../../../scripts/btst_analysis_utils.py)、[scripts/btst_profile_replay_utils.py](../../../../../scripts/btst_profile_replay_utils.py)、[scripts/btst_report_utils.py](../../../../../scripts/btst_report_utils.py)、[scripts/btst_candidate_entry_utils.py](../../../../../scripts/btst_candidate_entry_utils.py)、[scripts/btst_score_replay_utils.py](../../../../../scripts/btst_score_replay_utils.py)、[scripts/btst_top3_runbook_utils.py](../../../../../scripts/btst_top3_runbook_utils.py)，不要再跨脚本 import 其他分析脚本或下划线脚本里的私有 helper。
