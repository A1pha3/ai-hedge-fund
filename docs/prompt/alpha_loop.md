...
# 批量分析股票数据(一次分析一只股票)
- 运行此命令 uv run  python scripts/batch_run_hedge_fund.py --file data/stock/daliy/daily_gainers_20260302_gt5p0_20260302_182924.md  --model MiniMax-M2.5 --start-date 2025-05-30 --analysts-all  --limit 1 --show-reasoning  --exclude-boards 科创板 北交所
